...
public class Square2 extends Thread{
    private int x,y,e;
    private Random random;
    private Color c;
    private JFrame fs;
    
    public Square2(JFrame fs){            // I created square2 constructor which takes JFrame for using Turin class' JFrame and its x,y coordinates are 165,200 also edge length of square is 50. It's color is selected randomly// 
      random=new Random();
       x=165;
       y=200;
       e=50;
    ...
    public void run(){                                                            //This run method sets color of square2 randomly.//
    	Color []colors={Color.RED,Color.BLUE,Color.GREEN,Color.BLACK,Color.YELLOW,            // I created colors array which has 10 different colors.//
           ...
           while (4>3) {     
        	   try {
                 ...
                 setC(colors[random.nextInt(9)]);                                       // Setting color of square2 randomly from colors array.//
        }
        }
